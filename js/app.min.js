/*! UIkit 3.15.1 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */ (function (ue, de) {
    ...
    const Le = { ratio: Ti, contain: fs, cover: ho };
    function Qt(t, e, i, s) {
    ...
    function y(t, e, i) {
        ...
        } else for (const n of $(t)) mt(i) && (i = i.call(n, y(n, e))), i === null ? ge(n, e) : n.setAttribute(e, i);
    }
    function It(t, e) {
    ...
    function at(t, e) {
        for (const i of [e, "data-" + e]) if (It(t, i)) return y(t, i);
    }
    const co = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, menuitem: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 };
    function Ci(t) {
        ...
        if (((t = po(t)), ps(t))) {
            ...
            for (let n of s) {
                ...
                if (n[0] === "-") {
                    ...
                    (o = L(a, n.substr(1)) ? a : null), (n = r.slice(1).join(" "));
                }
                o && (t += (t ? "," : "") + vo(o) + " " + n);
            }
            e = document;
    ...
    function Nt(t, e, i, s) {
        return e === void 0 && (e = !0), i === void 0 && (i = !1), _(t) && (t = new CustomEvent(t, { bubbles: e, cancelable: i, detail: s })), t;
    }
    function Ei(t) {
    ...
    function c(t, e, i, s) {
        ...
        for (const o of n)
            if (_(e)) {
                if (((e = _i(e)), R(i))) return getComputedStyle(o).getPropertyValue(e);
    ...
    function I(t, e) {
        return ([e] = Di(e)), !!e && $(t).some((i) => i.classList.contains(e));
    }
    function W(t, e, i) {
        const s = Di(e);
        R(i) || (i = !!i);
                    ...
                    (n) =>
                        new Promise((o, r) => {
                            ...
                            N(
                                ...
                                (l) => {
                                    let { type: h } = l;
                                    clearTimeout(a), O(n, "uk-transition"), c(n, { transitionProperty: "", transitionDuration: "", transitionTimingFunction: "" }), h === "transitioncanceled" ? r() : o(n);
                                },
                                { self: !0 }
                            ),
                                b(n, "uk-transition"),
                                c(n, { transitionProperty: Object.keys(e).map(_i).join(","), transitionDuration: i + "ms", transitionTimingFunction: s, ...e });
                        })
                )
            )
        );
                    ...
                    (o) =>
                        new Promise((r, a) => {
                            ...
                            N(
                                ...
                                tt(e, xe) && (s && b(o, "uk-transform-origin-" + s), n && b(o, xe + "reverse"));
                        })
                )
            )
        );
    ...
    function x(t) {
        const e = Jt(t) ? q(t).getBoundingClientRect() : { height: G(t), width: ye(t), top: 0, left: 0 };
    ...
    function A(t, e) {
        ...
        if (t) {
            const { scrollY: n, scrollX: o } = Mt(t),
                r = { height: n, width: o };
            for (const a in zt) for (const l of zt[a]) i[l] += r[a];
        }
        if (!e) return i;
    ...
    function ie(t, e, i) {
        return i === void 0 && (i = "border-box"), c(t, "boxSizing") === i ? zt[e].map(kt).reduce((s, n) => s + w(c(t, "padding" + n)) + w(c(t, "border" + n + "Width")), 0) : 0;
    }
    function qe(t) {
        for (const e in zt) for (const i in zt[e]) if (zt[e][i] === t) return zt[e][1 - i];
        return t;
    }
    function J(t, e, i, s) {
        return (
    ...
    function Hi(t, e) {
        for (e = q(zi(t, e)); e.firstChild; ) e = e.firstChild;
        return j(e, t), e;
    }
    function Li(t, e) {
    ...
    const Do = 4;
    function Wi(t) {
        z.scheduled || ((z.scheduled = !0), t && t < Do ? Promise.resolve().then(() => Fi(t)) : requestAnimationFrame(() => Fi(1)));
    }
    function Cs(t) {
        let e;
        for (; (e = t.shift()); )
    ...
    (K.events = K.created = K.beforeConnect = K.connected = K.beforeDisconnect = K.disconnected = K.destroy = Ri),
        ...
        (K.update = function (t, e) {
            return ze(Ri(t, mt(e) ? { read: e } : e), "order");
        }),
    ...
    function re(t, e, i) {
        const s = {};
        if ((mt(e) && (e = e.options), e.extends && (t = re(t, e.extends, i)), e.mixins)) for (const o of e.mixins) t = re(t, o, i);
    ...
    function Os(t) {
        if ((Qe(t) && qi(t, { func: "playVideo", method: "play" }), Ze(t)))
            try {
                t.play().catch(T);
            } catch {}
    }
    function _s(t) {
        Qe(t) && qi(t, { func: "pauseVideo", method: "pause" }), Ze(t) && t.pause();
    }
    function Bs(t) {
        Qe(t) && qi(t, { func: "mute", method: "setVolume", value: 0 }), Ze(t) && (t.muted = !0);
    }
    function Ms(t) {
        return Ze(t) || Qe(t);
    }
    ...
    function Yi(t, e) {
        ...
        return s.reduce(
            (a, l, h) => {
                ...
                return i > 0 && f < E + i ? (F += i) : (i = 0), F > C ? ((i -= F - C), (F = C)) : F < 0 && ((i -= F), (F = 0)), () => n(l, F - u).then(a);
            },
            () => Promise.resolve()
        )();
        function n(a, l) {
    ...
    function Q(t, e, i) {
        ...
        return ~o && (n = n.slice(o)), [s].concat(n.filter((r) => e.test(c(r, "overflow")) && (!i || r.scrollHeight > lt(r).height))).reverse();
    }
    function lt(t) {
        const e = Mt(t),
            {
        ...
        for (let [r, a, l, h] of [
            ...
            Gt(s) ? (s = i) : (o[l] += w(c(s, "border-" + l + "-width"))), (o[r] = o[a] = s["client" + kt(r)]), (o[h] = o[r] + o[l]);
        return o;
    }
    function Hs(t) {
    ...
    function Ls(t, e, i) {
        (i = { attach: { element: ["left", "top"], target: ["left", "top"], ...i.attach }, offset: [0, 0], placement: [], ...i }), et(e) || (e = [e, e]), A(t, Fs(t, e, i));
    }
    function Fs(t, e, i) {
        const s = Ws(t, e, i),
    ...
    function Rs() {
        ...
        for (const n of i) for (const [, , o, r] of ht) (t[o] = Math.max(t[o] || 0, n[o])), (t[r] = Math.min(...[t[r], n[r]].filter(Boolean)));
        return t;
    }
    function ti(t, e, i) {
        const [, , s, n] = ht[i];
    ...
    function qo(t, e, i, s) {
        ...
        return Ws(t, e, { attach: { element: qs(o.element, s), target: qs(o.target, s) }, offset: Yo(n, s) });
    }
    function Vo(t, e, i) {
        return Fs(t, e, { ...i, attach: { element: i.attach.element.map(Vs).reverse(), target: i.attach.target.map(Vs).reverse() }, offset: i.offset.reverse(), placement: i.placement.reverse(), recursion: !0 });
    }
    function qs(t, e) {
        const i = [...t],
            s = ht[e].indexOf(t[e]);
    ...
    function Go(t) {
        ...
        (t.use = function (n) {
            ...
            (t.update = function (n, o) {
                ...
                for (const r of Ut(n).reverse()) s(r[e], o);
                vt(n, (r) => s(r[e], o));
            });
        let i;
    ...
    function Jo(t) {
        (t.prototype._callHook = function (s) {
            ...
            (t.prototype._callConnected = function () {
                this._connected ||
                    ((this._data = {}), (this._computed = {}), this._initProps(), this._callHook("beforeConnect"), (this._connected = !0), this._initEvents(), this._initObservers(), this._callHook("connected"), this._callUpdate());
            }),
        ...
        function e(s) {
            for (const { read: n, write: o, events: r = [] } of this.$options.update) {
                ...
                let a;
                n && ((a = n.call(this, this._data, s)), a && Tt(a) && xt(this._data, a)),
                    o &&
                        a !== !1 &&
                        z.write(() => {
    ...
    function Ko(t) {
        ...
        (t.prototype._init = function (i) {
            ...
            (t.prototype._initComputeds = function () {
                ...
                if (((this._computed = {}), i)) for (const s in i) Zo(this, s, i[s]);
            }),
            (t.prototype._initProps = function (i) {
                ...
                for (s in this.$props) s in i && Qo(n, s) && (this[s] = this.$props[s]);
            }),
    ...
    function ei(t, e, i) {
        ...
        !n || (h && !h.call(t)) || t._events.push(k(n, s, l ? (_(l) ? l : l.call(t)) : null, _(o) ? t[o] : o.bind(t), { passive: a, capture: r, self: u }));
    }
    function Qo(t, e) {
    ...
    function tr(t, e) {
        let { data: i = {} } = t,
            { args: s = [], props: n = {} } = e;
        et(i) && (i = i.slice(0, s.length).reduce((o, r, a) => (Tt(r) ? xt(o, r) : (o[s[a]] = r), o), {}));
        for (const o in i) R(i[o]) ? delete i[o] : n[o] && (i[o] = Ji(n[o], i[o]));
        return i;
    }
    function er(t) {
    ...
    function nr(t) {
        ...
        (t.component = function (s, n) {
            ...
            t[s] = function (a, l) {
                ...
                return h.options.functional ? new h({ data: Tt(a) ? a : [...arguments] }) : a ? D(a).map(u)[0] : u();
                function u(d) {
            ...
            return (r.name = s), r.install == null || r.install(t, r, s), t._initialized && !r.functional && z.read(() => t[s]("[uk-" + o + "],[data-uk-" + o + "]")), (i[s] = Tt(n) ? r : n);
        }),
    ...
    var nt = {
        ...
        Et = {
            ...
            methods: {
                    ...
                    return new Promise((s) =>
                        Promise.all(
                            $(t).map((n) => {
                                ...
                                const l = () => {
                                    O(n, a), g(n, o ? "shown" : "hidden", [this]), this.$update(n);
                                };
                ...
                isToggled(t) {
                    return t === void 0 && (t = this.$el), ([t] = $(t)), I(t, this.clsEnter) ? !0 : I(t, this.clsLeave) ? !1 : this.cls ? I(t, this.cls.split(" ")[0]) : V(t);
                },
                _toggle(t, e) {
                    if (!t) return;
                    e = Boolean(e);
                    let i;
                    this.cls ? ((i = p(this.cls, " ") || e !== I(t, this.cls)), i && W(t, this.cls, p(this.cls, " ") ? void 0 : e)) : ((i = e === t.hidden), i && (t.hidden = !e)),
    ...
    function rr(t) {
        let { _toggle: e } = t;
        return (i, s) => (ft.cancel(i), S.cancel(i), e(i, s));
    }
    function Gs(t) {
        var e;
        ...
        return async (d, f) => {
            ...
            !ce && !f && (F += so);
            const [wi] = Li(d, "<div>");
            c(wi, { boxSizing: "border-box", height: Me.height, width: Me.width, ...c(d, ["overflow", "padding", "borderTop", "borderRight", "borderBottom", "borderLeft", "borderImage", u]) }),
                c(d, { padding: 0, border: 0, minWidth: 0, minHeight: 0, [u]: 0, width: Me.width, height: Me.height, overflow: "hidden", [l]: F });
            const no = F / Vt;
            m = (C * Vt + m) * (f ? 1 - no : no);
            const oo = { [l]: f ? Vt : 0 };
            r && (c(d, h, Vt - F + cs), (oo[h] = f ? cs : Vt + cs)), !r ^ (i === "reveal") && (c(wi, h, -Vt + F), S.start(wi, { [h]: f ? 0 : -Vt }, m, E));
            try {
    ...
    function ar(t) {
        return (e, i) => {
            ...
            return i ? (o(e, !0), ft.in(e, s[0], n, t.origin)) : ft.out(e, s[1] || s[0], n, t.origin).then(() => o(e, !1));
        };
    }
    var Js = {
        mixins: [nt, Se, Et],
                ...
                if ((!this.multiple && !p(s, i[0]) && (i = i.concat(s)), !(!this.collapsible && s.length < 2 && !ve(i, ":not(." + this.clsOpen + ")").length)))
                    for (const n of i)
                        this.toggleElement(n, !I(n, this.clsOpen), async (o, r) => {
                            W(o, this.clsOpen, r), y(v(this.$props.toggle, o), "aria-expanded", r);
                            const a = v(this.content, o);
                            if (e === !1 || !this.animation) {
                                (a.hidden = !r), Ks(a, !r);
                                return;
                            }
                            if ((await Gs(this)(a, r), r)) {
                                const l = v(this.$props.toggle, o);
                                z.read(() => {
                                    Ue(l) || Yi(l, { offset: this.offset });
                                });
                            }
                        });
            },
    ...
    var lr = {
        ...
        methods: {
            async close() {
                await this.toggleElement(this.$el, !1, hr(this)), this.$destroy(!0);
            },
        },
    };
    function hr(t) {
        ...
        return (n) => {
            ...
            return c(n, "height", o), S.start(n, { height: 0, marginTop: 0, marginBottom: 0, paddingTop: 0, paddingBottom: 0, borderTop: 0, borderBottom: 0, opacity: 0 }, s * o + e, i);
        };
    }
    var Zs = {
            args: "autoplay",
            ...
            update: {
                read() {
                    return Ms(this.$el) ? { visible: V(this.$el) && c(this.$el, "visibility") !== "hidden", inView: this.inView && Ue(this.$el) } : !1;
                },
                write(t) {
    ...
    var Ki = {
        ...
        events: [
            ...
            },
            {
                ...
                handler() {
                    N(
                        ...
                        this.overlay && (N(this.$el, "hidden", tn(this.$el), { self: !0 }), N(this.$el, "hidden", en(), { self: !0 })),
            ...
            },
            {
                ...
                self: !0,
                handler() {
                    p(ot, this) && ot.splice(ot.indexOf(this), 1), c(this.$el, "zIndex", ""), ot.some((t) => t.clsPage === this.clsPage) || O(document.documentElement, this.clsPage);
                },
            },
        ],
        methods: {
            ...
            show() {
                return this.container && P(this.$el) !== this.container ? (j(this.container, this.$el), new Promise((t) => requestAnimationFrame(() => this.show().then(t)))) : this.toggleElement(this.$el, !0, Us(this));
            },
            hide() {
            ...
            new Promise((o, r) =>
                N(s, "show hide", () => {
                    ...
                    const a = N(
                            ...
                            "transitionstart",
                            () => {
                                N(e, "transitionend transitioncancel", o, { self: !0 }), clearTimeout(l);
                            },
                            { self: !0 }
                        ),
                        l = setTimeout(() => {
    ...
    function en() {
        ...
        return (
            ...
            () => {
                (Zi = !1), c(t, { overflowY: "", touchAction: "", paddingRight: "" });
            }
        );
    }
    function pr(t, e) {
    ...
    var sn = {
        ...
        connected() {
            b(this.$el, this.clsDrop),
                this.toggle && !this.targetEl && ((this.targetEl = this.$create("toggle", dt(this.toggle, this.$el), { target: this.$el, mode: this.mode }).$el), y(this.targetEl, "aria-haspopup", !0), this.lazyload(this.targetEl));
        },
        disconnected() {
                ...
                handler() {
                    ...
                    const t = () => this.$emit(),
                        e = [
                            ...
                            ...(this.autoUpdate ? [k([document, Q(this.$el)], "scroll", t, { passive: !0 })] : []),
        ...
        methods: {
            show(t, e) {
                if ((t === void 0 && (t = this.targetEl), e === void 0 && (e = !0), this.isToggled() && t && this.targetEl && t !== this.targetEl && this.hide(!1, !1), (this.targetEl = t), this.clearTimers(), !this.isActive())) {
                    if (Y) {
                        ...
                        let i;
                        for (; Y && i !== Y && !B(this.$el, Y.$el); ) (i = Y), Y.hide(!1, !1);
                    }
                    this.container && P(this.$el) !== this.container && j(this.container, this.$el), (this.showTimer = setTimeout(() => this.toggleElement(this.$el, !0), (e && this.delayShow) || 0));
                }
            },
            hide(t, e) {
            ...
            position() {
                ...
                for (const [r, [a, l]] of n) this.axis !== a && p([a, !0], this.stretch) && c(this.$el, { [l]: Math.min(e[l], i[r][l] - 2 * s), ["overflow-" + a]: "auto" });
                ...
                for (const [r, [a, l, h, u]] of n)
                    if (this.axis === a && p([a, !0], this.stretch)) {
                        const d = Math.abs(this.getPositionOffset(this.$el)),
                            f = A(this.target[r]),
                            m = A(this.$el);
                        c(this.$el, { [l]: (f[h] > m[h] ? f[h] - Math.max(e[h], i[r][h] + s) : Math.min(e[u], i[r][u] - s) - f[u]) - d, ["overflow-" + a]: "auto" }), this.positionAt(this.$el, this.target, t);
                    }
            },
        },
    };
    ...
    var mr = {
        ...
        nn = {
            ...
            connected() {
                this.registerObserver(Ps(this.$el, () => this.$reset(), { childList: !0 }));
            },
            update: {
                read() {
                ...
                write(t) {
                    ...
                    for (const s of i) for (const n of s) W(n, this.margin, i[0] !== s), W(n, this.firstColumn, e[0].includes(n));
                },
                events: ["resize"],
            },
        };
    ...
    let Ce;
    function wr(t, e) {
        (Ce = Ce || k(window, "scroll", () => si.forEach((i) => i()), { passive: !0, capture: !0 })), si.set(t, e);
    }
    function br(t) {
    ...
    var xr = {
        ...
        update: [
            ...
            },
            {
                read(t) {
                    ...
                    const n = M(this.$el),
                        ...
                        a = Math.max(...o) + r;
                    this.masonry && ((e = e.map((h) => ze(h, "offsetTop"))), (s = yr(i, e)));
            ...
            {
                read() {
                    return this.parallax && rn(this.$el) ? !1 : { scrolled: this.parallax ? Xi(this.$el) * Math.abs(this.parallax) : !1 };
                },
                write(t) {
    ...
    var Sr = {
        ...
        update: {
            read() {
                return { rows: (this.row ? Qi(this.elements) : [this.elements]).map(Tr) };
            },
            write(t) {
                let { rows: e } = t;
    ...
    var Ir = {
            ...
            update: {
                read(t) {
                    ...
                    const s = ie(this.$el, "height", "content-box"),
                        ...
                        { height: a } = lt(r === n ? o : r);
                    if (this.expand) i = Math.max(a - (x(r).height - x(this.$el).height) - s, 0);
                    else {
                        const l = o === r || n === r;
                        ...
                        this.offsetBottom === !0
                            ...
                            : _(this.offsetBottom) && (i += " - " + x(dt(this.offsetBottom, this.$el)).height + "px"),
                            (i += (s ? " - " + s + "px" : "") + ")");
                    }
        ...
        an = {
                ...
                !this.icon && p(this.src, "#") && ([this.src, this.icon] = this.src.split("#")),
                    (this.svg = this.getSvg().then((t) => {
                        if (this._connected) {
                            ...
                            return this.svgEl && e !== this.svgEl && ct(this.svgEl), this.applyAttributes(e, t), (this.svgEl = e);
                        }
                    }, T)),
            ...
            disconnected() {
                this.svg.then((t) => {
                    this._connected || (Ci(this.$el) && (this.$el.hidden = !1), ct(t), (this.svgEl = null));
                }),
                    (this.svg = null);
            },
            methods: {
                ...
                applyAttributes(t, e) {
                    for (const o in this.$options.props) p(this.include, o) && o in this && y(t, o, this[o]);
                    ...
                    const n = y(e, "viewBox");
                    n && !s.some((o) => o) && (s = n.split(" ").slice(2)), s.forEach((o, r) => y(t, i[r], w(o) * this.ratio || null));
                },
            },
        };
    ...
    function Er(t, e) {
        if (!ni[t]) {
            (ni[t] = {}), (ln.lastIndex = 0);
            let i;
            for (; (i = ln.exec(t)); ) ni[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>";
        }
        return ni[t][e];
    }
    function hn(t) {
    ...
    const oi = {
        ...
        ut = {
            args: !1,
            extends: Ui,
            data: (t) => ({ icon: _t(t.constructor.options.name) }),
            beforeConnect() {
                b(this.$el, this.$name);
            },
        },
    ...
    var oa = {
        ...
        connected() {
            ...
            (na && ai(this.$el) && ((this.$el.loading = "lazy"), ts(this.$el), t.length === 1)) ||
                (ca(this.$el),
                this.registerObserver(
                    oe(
                        t,
    ...
    function ha(t) {
        ...
        return et(t) || (t = [t]), t.filter((e) => !fe(e));
    }
    function ca(t) {
    ...
    var li = {
        ...
        connected() {
            ...
            if (((this.matchMedia = !0), t)) {
                ...
                const e = () => {
                    (this.matchMedia = this.mediaObj.matches), g(this.$el, Nt("mediachange", !1, !0, [this.mediaObj]));
                };
    ...
    function da(t, e) {
        if (_(t)) {
            if (tt(t, "@")) t = w(c(e, "--uk-breakpoint-" + t.substr(1)));
    ...
    var ma = { extends: Js, data: { targets: "> .uk-parent", toggle: "> a", content: "> ul" } },
        va = {
            mixins: [nt, ae],
            props: {
                dropdown: String,
            ...
            computed: {
                ...
                toggles: {
                    ...
                    watch() {
                        ...
                        for (const e of D(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right", this.$el)) c(e, "flexGrow", t ? D(this.dropdown, e).length : "");
                    },
                    immediate: !0,
                },
            },
                    ...
                    handler(t) {
                        ...
                        this._observer = Ke([i.$el, ...i.target], () => {
                            const s = Ut(e, "." + this.clsDrop)
                                ...
                                r = A(this.dropbar);
                            c(this.dropbar, "top", this.dropbar.offsetTop - (r.top - n)), this.transitionTo(o - n + w(c(e, "marginBottom")), e);
                        });
                    },
                },
                {
    ...
    var $a = {
            ...
            update: {
                read() {
                    return !this.content || !this.container || !V(this.$el) ? !1 : { max: Math.max(this.minHeight, G(this.container) - (x(this.content).height - G(this.$el))) };
                },
                write(t) {
                    let { max: e } = t;
        ...
        ka = {
            ...
            update: {
                read() {
                    return V(this.$el) && this.width && this.height ? { width: ye(P(this.$el)), height: this.height } : !1;
                },
                write(t) {
                    G(this.$el, Le.contain({ height: this.height, width: this.width }, t).height);
                },
                events: ["resize"],
            },
        },
        Sa = {
            ...
            methods: {
                async scrollTo(t) {
                    (t = (t && v(t)) || document.body), g(this.$el, "beforescroll", [this, t]) && (await Yi(t, { offset: this.offset }), g(this.$el, "scrolled", [this, t]));
                },
            },
        };
    const Ie = new Set();
    ...
    function bn(t) {
        if (!t.defaultPrevented) for (const e of Ie) B(t.target, e.$el) && (t.preventDefault(), e.scrollTo(xn(e.$el)));
    }
    function xn(t) {
    ...
    var Ia = {
                        ...
                        oe(
                            ...
                            (t) => {
                                ...
                                for (const { target: i, isIntersecting: s } of t) {
                                    e.has(i) || e.set(i, { cls: at(i, "uk-scrollspy-class") || this.cls });
                                    const n = e.get(i);
        ...
        Aa = {
            ...
            update: [
                {
                    read(t, e) {
                        ...
                        n && (c(this.selTarget, "transition", "0s"), this.hide()), this.active || ((i = A(this.$el).height), (s = c(this.$el, "margin"))), n && (this.show(), requestAnimationFrame(() => c(this.selTarget, "transition", "")));
                        ...
                        return { start: d, end: f, offset: l, overflow: h, topOffset: u, height: i, margin: s, width: x(o).width, top: Ht(o)[0] };
                    },
                    write(t) {
                        let { height: e, margin: i } = t;
                        const { placeholder: s } = this;
                        c(s, { height: e, margin: i }), B(s, document) || (Ve(this.$el, s), (s.hidden = !0));
                    },
                    events: ["resize"],
                },
                {
                    read(t) {
                        ...
                        return { dir: e <= a ? "down" : "up", prevDir: i, scroll: a, prevScroll: e, offsetParentTop: A((this.isFixed ? this.placeholder : this.$el).offsetParent).top, overflowScroll: Z(n + Z(a, o, r) - Z(e, o, r), 0, s) };
                    },
                    write(t, e) {
                        ...
                        if (((f - s > 300 || n !== o) && ((t.initScroll = r), (t.initTimestamp = f)), !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10)))
                            if (this.inactive || r < h || (this.showOnUp && (r <= h || (n === "down" && i) || (n === "up" && !this.isFixed && r <= u + d)))) {
                                ...
                                (this.isFixed = !1), this.animation && r > u ? (ft.cancel(this.$el), ft.out(this.$el, this.animation).then(() => this.hide(), T)) : this.hide();
            ...
            methods: {
                ...
                hide() {
                    this.setActive(!1), O(this.$el, this.clsFixed, this.clsBelow), c(this.$el, { position: "", top: "", width: "" }), (this.placeholder.hidden = !0);
                },
                update() {
                    ...
                    const u = n !== 0 || e > n;
                    let d = "fixed";
                    e > o && ((r += o - h), (d = "absolute")), i && (r -= s), c(this.$el, { position: d, top: r + "px", width: t }), this.setActive(u), W(this.$el, this.clsBelow, e > a + l), b(this.$el, this.clsFixed);
                },
                setActive(t) {
                    const e = this.active;
                ...
                connects: {
                    ...
                    watch(t) {
                        ...
                        this.connects.forEach((i) => {
                            M(i).forEach((s, n) => W(s, this.cls, n === e)), this.lazyload(this.$el, M(i));
                        });
                    },
                    immediate: !0,
                },
            ...
            methods: {
                ...
                show(t) {
                    ...
                    M(this.$el).forEach((o, r) => {
                        W(o, this.cls, s === r), y(this.toggles[r], "aria-expanded", s === r);
                    });
                    const n = e >= 0 && e !== i;
                    this.connects.forEach(async (o) => {
                        let { children: r } = o;
                        await this.toggleElement(
                            $(r).filter((a) => I(a, this.cls)),
                            !1,
                            n
                        ),
    ...
    var _a = {
            ...
            connected() {
                !p(this.mode, "media") && !je(this.$el) && y(this.$el, "tabindex", "0"), Ni(() => this.$emit());
            },
            events: [
                {
                    name: gt,
    ...
    yt(Ba, (t, e) => st.component(e, t)), or(st);
    ...
    function Sn(t, e, i, s) {
        ...
        const n = hi(e, !0),
            ...
            l = a(() => (b(e, es), Promise.all(Cn(e).map((u, d) => new Promise((f) => setTimeout(() => S.start(u, r, i / 2, "ease").then(f), d * s)))).then(() => O(e, es)))),
            h = a(() => {
                const u = G(e);
                return (
                    b(e, is),
                    ...
                    new Promise((d) =>
                        requestAnimationFrame(() => {
                            ...
                            u !== m && E.push(S.start(e, { height: m }, i / 2 + C.length * s, "ease")),
                                Promise.all(E).then(() => {
                                    O(e, is), n === hi(e) && (c(e, { height: "", alignContent: "" }), c(f, { opacity: "" }), delete e.dataset.transition), d();
                                });
                        })
                    )
                );
                    ...
                    Promise.resolve().then(() => {
                        ...
                        n.forEach((u, d) => h[d] && c(u, h[d])),
                            ...
                            requestAnimationFrame(() => {
                                ...
                                Promise.all(u)
                                    .then(() => {
                                        n.forEach((d, f) => P(d) === e && c(d, "display", l[f].opacity === 0 ? "none" : "")), Pn(e);
                                    }, T)
                                    .then(s);
                            });
                    });
    ...
    function In(t, e) {
        const i = c(t, "zIndex");
        return V(t) ? { display: "", opacity: e ? c(t, "opacity") : "0", pointerEvents: "none", position: "absolute", zIndex: i === "auto" ? te(t) : i, ...An(t) } : !1;
    }
    function Ha(t, e, i) {
        const s = e.map((o, r) => (P(o) && r in i ? (i[r] ? (V(o) ? An(o) : { opacity: 0 }) : { opacity: V(o) ? 1 : 0 }) : !1)),
            n = s.map((o, r) => {
    ...
    function Pn(t) {
        c(t.children, { height: "", left: "", opacity: "", pointerEvents: "", position: "", top: "", marginTop: "", marginLeft: "", transform: "", width: "", zIndex: "" }), c(t, { height: "", display: "", padding: "" });
    }
    function An(t) {
        const { height: e, width: i } = A(t),
            { top: s, left: n } = Re(t),
            { marginLeft: o, marginTop: r } = c(t, ["marginTop", "marginLeft"]);
        return { top: s, left: n, height: e, width: i, marginLeft: o, marginTop: r, transform: "" };
    }
    var En = {
            ...
            methods: {
                animate(t, e) {
                    ...
                    return (i === "fade"
                        ...
                        : i
                        ? za
                        : () => (t(), Promise.resolve()))(t, e, this.duration).then(() => this.$update(e, "resize"), T);
                },
            },
        },
        La = {
                    ...
                    e === void 0 && (e = !0),
                        ...
                        await Promise.all(
                            D(this.target, this.$el).map((i) => {
                                const s = () => {
                                    Wa(t, i, M(i)), this.$update(this.$el);
                                };
    ...
    function _n(t, e, i) {
        ...
        return (n || R(r)) && (o ? (n ? (delete i.filter[""], (i.filter[o] = n)) : (delete i.filter[o], (fe(i.filter) || "" in i.filter) && (i.filter = { "": n || "" }))) : (i.filter = { "": n || "" })), R(r) || (i.sort = [r, a]), i;
    }
    function ja(t, e, i) {
        let {
            filter: s = { "": "" },
    ...
    function Va(t, e, i) {
        return [...t].sort((s, n) => at(s, e).localeCompare(at(n, e), void 0, { numeric: !0 }) * (i === "asc" || -1));
    }
    var ss = {
        slide: {
            show(t) {
                return [{ transform: H(t * -100) }, { transform: H() }];
            },
            percent(t) {
                return Pe(t);
            },
            translate(t, e) {
                return [{ transform: H(e * -100 * t) }, { transform: H(e * 100 * (1 - t)) }];
            },
        },
    };
    function Pe(t) {
    ...
    var Bn = {
        ...
        scale: {
            show() {
                return [
                    { opacity: 0, transform: le(1 - 0.2) },
                    { opacity: 1, transform: le(1) },
                ];
            },
            percent(t) {
                return 1 - c(t, "opacity");
            ...
            translate(t) {
                return [
                    { opacity: 1 - t, transform: le(1 - 0.2 * t) },
                    { opacity: t, transform: le(1 - 0.2 + 0.2 * t) },
                ];
            },
        },
    };
    function Ya(t, e, i, s) {
        ...
        return {
            ...
            show(d, f, m) {
                ...
                const C = m ? "linear" : o;
                return (
                    (d -= Math.round(d * Z(f, -1, 1))),
                    this.translate(f),
                    ci(e, "itemin", { percent: f, duration: d, timing: C, dir: i }),
                    ci(t, "itemout", { percent: 1 - f, duration: d, timing: C, dir: i }),
            ...
            translate(d) {
                this.reset();
                const f = a(d, i);
                c(e, f[1]), c(t, f[0]), ci(e, "itemtranslatein", { percent: d, dir: i }), ci(t, "itemtranslateout", { percent: 1 - d, dir: i });
            },
            percent() {
                return r(t || e, e, i);
            },
    ...
    var Xa = {
        ...
        methods: {
            startAutoplay() {
                this.stopAutoplay(), (this.interval = setInterval(() => (!this.draggable || !v(":focus", this.$el)) && (!this.pauseOnHover || !L(this.$el, ":hover")) && !this.stack.length && this.show("next"), this.autoplayInterval));
            },
            stopAutoplay() {
    ...
    var Ja = {
        ...
        methods: {
            ...
            move(t) {
                ...
                if ((Dt(document, ns, this.move, Ae), Dt(document, os, this.end, Ae), this.dragging))
    ...
    var Nn = {
            ...
            data: { animation: "slide", clsActivated: "uk-transition-active", Animations: ss, Transitioner: Ya },
            computed: {
                animation(t) {
        ...
        zn = {
            ...
            created() {
                const t = v(this.template),
                    e = v(this.selList, t);
                this.items.forEach(() => j(e, "<li>")), this.$mount(j(this.container, t));
            },
            computed: {
                caption(t, e) {
                    let { selCaption: i } = t;
                    ...
                    async handler(t, e) {
                        ...
                        if (s === "image" || i.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i))
                            try {
                                ...
                                this.setItem(e, Ee("img", { src: i, width: h, height: u, alt: n, ...r }));
                            } catch {
                                this.setError(e);
                            }
                        else if (s === "video" || i.match(/\.(mp4|webm|ogv)($|\?)/i)) {
                            const h = Ee("video", { src: i, poster: o, controls: "", playsinline: "", "uk-video": "" + this.videoAutoplay, ...r });
                            k(h, "loadedmetadata", () => {
                                y(h, { width: h.videoWidth, height: h.videoHeight }), this.setItem(e, h);
                            }),
                                k(h, "error", () => this.setError(e));
                        } else if (s === "iframe" || i.match(/\.(html|php)($|\?)/i)) this.setItem(e, Ee("iframe", { src: i, frameborder: "0", allowfullscreen: "", class: "uk-lightbox-iframe", ...r }));
                        else if ((a = i.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)))
                            this.setItem(e, Ee("iframe", { src: "https://www.youtube" + (a[1] || "") + ".com/embed/" + a[2] + (a[3] ? "?" + a[3] : ""), width: 1920, height: 1080, ...l, ...r }));
                            ...
                            try {
                                ...
                                this.setItem(e, Ee("iframe", { src: "https://player.vimeo.com/video/" + a[1] + (a[2] ? "?" + a[2] : ""), width: u, height: h, ...l, ...r }));
                            } catch {
                                this.setError(e);
                            }
                    },
    ...
    var Ua = {
        ...
        methods: {
            show(t) {
                ...
                return (this.panel = this.panel || this.$create("lightboxPanel", { ...this.$props, items: e })), k(this.panel.$el, "hidden", () => (this.panel = !1)), this.panel.show(t);
            },
            hide() {
                var t;
    ...
    function Hn(t) {
        const e = {};
        for (const i of ["href", "caption", "type", "poster", "alt", "attrs"]) e[i === "href" ? "source" : i] = at(t, i);
    ...
    var el = {
        ...
        methods: {
            async close(t) {
                const e = (i) => {
                    const s = P(i);
                    g(i, "close", [this]), ct(i), (s != null && s.hasChildNodes()) || ct(s);
                };
    ...
    const ui = { x: di, y: di, rotate: di, scale: di, color: rs, backgroundColor: rs, borderColor: rs, blur: qt, hue: qt, fopacity: qt, grayscale: qt, invert: qt, saturate: qt, sepia: qt, opacity: nl, stroke: ol, bgx: Wn, bgy: Wn },
        { keys: Ln } = Object;
    var Fn = {
        mixins: [li],
        props: Vn(Ln(ui), "list"),
        ...
        computed: {
            props(t, e) {
                const i = {};
                for (const n in t) n in ui && !R(t[n]) && (i[n] = t[n].slice());
                const s = {};
    ...
    function di(t, e, i) {
        let s = pi(i) || { x: "px", y: "px", rotate: "deg" }[t] || "",
            n;
        return (
            t === "x" || t === "y" ? ((t = "translate" + kt(t)), (n = (o) => w(w(o).toFixed(s === "px" ? 0 : 6)))) : t === "scale" && ((s = ""), (n = (o) => (pi([o]) ? J(o, "width", e, !0) / e.offsetWidth : o))),
    ...
    function ol(t, e, i) {
        ...
        const s = pi(i),
            n = cn(e);
        return (
            (i = he(i.reverse(), (o) => ((o = w(o)), s === "%" ? (o * n) / 100 : o))),
            i.some((o) => {
                let [r] = o;
                return r;
            })
    ...
    var hl = {
        ...
        update: {
            read(t, e) {
                ...
                const s = i;
                return (i = cl(Xi(this.target, this.start, this.end), this.easing)), { percent: i, style: s === i ? !1 : this.getCss(i) };
            },
            write(t) {
                let { style: e } = t;
                if (!this.matchMedia) {
    ...
    function ul(t, e, i, s) {
        ...
        return {
            ...
            show(u, d, f) {
                ...
                const m = f ? "linear" : o;
                return (
                    (u -= Math.round(u * Z(d, -1, 1))),
                    this.translate(d),
                    (d = t ? d : Z(d, 0, 1)),
                    ls(this.getItemIn(), "itemin", { percent: d, duration: u, timing: m, dir: i }),
                    t && ls(this.getItemIn(!0), "itemout", { percent: 1 - d, duration: u, timing: m, dir: i }),
                    S.start(r, { transform: H(-h * (X ? -1 : 1), "px") }, u, m).then(a.resolve, T),
                    a.promise
                );
            },
            cancel() {
            ...
            translate(u) {
                ...
                for (const E of M(r)) {
                    ...
                    ls(E, "itemtranslate" + (hs ? "in" : "out"), { dir: i, percent: ce ? 1 - u : F ? u : U ? 1 : 0 });
                }
            },
            percent() {
    ...
    var fl = {
        ...
        data: { center: !1, sets: !1, attrItem: "uk-slider-item", selList: ".uk-slider-items", selNav: ".uk-slider-nav", clsContainer: "uk-slider-container", Transitioner: ul },
        computed: {
            avgWidth() {
        ...
        methods: {
            ...
            updateActiveClasses() {
                ...
                for (const i of this.slides) W(i, e, p(t, i));
            },
            getValidIndex(t, e) {
                ...
                handler(t) {
                    ...
                    z.read(() => {
                        const r = this.getCss(Un(e, o, i)),
                            a = this.getCss(Qn(e) ? 0.5 : o > 0 ? 1 : 0);
                        z.write(() => {
    ...
    var gl = {
            ...
            pull: {
                show(t) {
                    return t < 0
                        ? [
                              { transform: H(30), zIndex: -1 },
                              { transform: H(), zIndex: 0 },
                          ]
                        : [
                              { transform: H(-100), zIndex: 0 },
                              { transform: H(), zIndex: -1 },
                          ];
                },
                percent(t, e, i) {
                ...
                translate(t, e) {
                    return e < 0
                        ? [
                              { transform: H(30 * t), zIndex: -1 },
                              { transform: H(-100 * (1 - t)), zIndex: 0 },
                          ]
                        : [
                              { transform: H(-t * 100), zIndex: 0 },
                              { transform: H(30 * (1 - t)), zIndex: -1 },
                          ];
                },
            },
            push: {
        ...
        ml = {
            ...
            data: { ratio: "16:9", minHeight: !1, maxHeight: !1, selList: ".uk-slideshow-items", attrItem: "uk-slideshow-item", selNav: ".uk-slideshow-nav", Animations: gl },
            update: {
                read() {
                    if (!this.list) return !1;
                    let [t, e] = this.ratio.split(":").map(Number);
                    return (e = (e * this.list.offsetWidth) / t || 0), this.minHeight && (e = Math.max(this.minHeight, e)), this.maxHeight && (e = Math.min(this.maxHeight, e)), { height: e - ie(this.list, "height", "content-box") };
                },
                write(t) {
                    let { height: e } = t;
            ...
            methods: {
                init(t) {
                    ...
                    !n ||
                        ...
                        (this.placeholder = n),
                        (this.origin = { target: e, index: te(n), ...this.pos }),
                ...
                move(t) {
                    ...
                    this === t ? this.origin.index !== te(this.placeholder) && g(this.$el, "moved", [this, this.placeholder]) : (g(t.$el, "added", [t, this.placeholder]), g(this.$el, "removed", [this, this.placeholder])),
    ...
    function xl(t, e) {
        ...
        return c(i, "margin", "0", "important"), c(i, { boxSizing: "border-box", width: e.offsetWidth, height: e.offsetHeight, padding: c(e, "padding") }), G(i.firstElementChild, G(e.firstElementChild)), i;
    }
    function yl(t, e) {
            ...
            show() {
                this.isToggled(this.tooltip || null) ||
                    ...
                    ((this._unbind = N(
                        ...
                        this.hide,
                        !1,
                        (t) => (t.type === gt && !B(t.target, this.$el)) || (t.type === "keydown" && t.keyCode === 27) || (t.type === "show" && t.detail[0] !== this && t.detail[0].$name === this.$name)
                    )),
                    clearTimeout(this.showTimer),
                    (this.showTimer = setTimeout(this._show, this.delay)));
            },
            async hide() {
                L(this.$el, "input:focus") || (clearTimeout(this.showTimer), this.isToggled(this.tooltip || null) && (await this.toggleElement(this.tooltip, !1, !1), ct(this.tooltip), (this.tooltip = null), this._unbind()));
            },
            _show() {
    ...
    return yt(Al, (t, e) => st.component(e, t)), st;
});
